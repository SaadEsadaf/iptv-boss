const topics = [
  ...
  {
    id: 'atlas_pro_setup',
    keywords: ['atlas', 'atlas pro', 'atlas iptv', 'atlas ontv', 'atlas 9x', 'atlas pro ontv', 'atlas pro iptv ontv gse', 'ontv', '9x'],
    audience: 'both',
    summary: "Atlas Pro IPTV is a French-focused premium IPTV provider. It has official dedicated apps and also works with third-party players via Xtream Codes credentials. The official apps use a simple activation code — no need to enter server URLs or complex settings.",
    steps: [
      '--- OFFICIAL APPS (RECOMMENDED) ---',
      'These apps are designed specifically for Atlas. No server URLs needed — just enter your activation code.',
      '',
      'For Android TV & Amazon Fire TV:',
      'App: Atlas Pro ONTV (also called Atlas 9X)',
      'Where to get it: Amazon Appstore or direct APK download.',
      'Setup:',
      'Step 1: Install the app on your device.',
      'Step 2: Open the app. Enter your Activation Code (numbers/letters).',
      'Step 3: Click "Login" or "Connexion". The app auto-loads channels and EPG.',
      '',
      'For Apple devices (iPhone, iPad, Apple TV):',
      'App: Atlas Pro IPTV Ontv GSE',
      'Where to get it: Official Apple App Store.',
      'Setup:',
      'Step 1: Install the app from the App Store.',
      'Step 2: Open the app. Enter your active subscriber code.',
      'Step 3: Live channels and VOD (movies/series) load instantly.',
      '',
      '--- THIRD-PARTY APPS (Xtream Codes) ---',
      'If you prefer a custom interface (TiviMate, IPTV Smarters, etc.), use your Xtream Codes credentials:',
      '- Server URL (e.g. http://example.com:8080)',
      '- Username',
      '- Password',
      '',
      'Best third-party apps by device:',
      '- Samsung/LG Smart TV: IBO Player or Smart IPTV (from TV app store)',
      '- Android TV / Firestick: TiviMate IPTV Player (best premium interface, EPG, favorites, fast zapping)',
      '- Universal (all devices): IPTV Smarters Pro — the most famous, simple, works everywhere',
      '',
      'Steps for third-party setup:',
      'Step 1: Open your chosen app.',
      'Step 2: Select "Login with Xtream Codes API" (preferred over M3U for EPG).',
      'Step 3: Name your profile (e.g. "Atlas").',
      'Step 4: Enter Username, Password, and Server URL exactly as provided.',
      'Step 5: Tap "Add User" or "Login". Wait for channels to load.',
      '',
      '--- IPTV IN FRANCE - IMPORTANT TIPS ---',
      '',
      'ISP blocking: French ISPs (Orange, SFR, Bouygues, Free) may block or throttle IPTV, especially during big football matches (Ligue 1, Champions League).',
      'If you experience cuts on a working fibre connection, use a VPN set to a neighbouring European country — it fixes the issue instantly.',
      '',
      'Test before buying: Never commit to a 12-month plan without a free 24h or 48h test first. This confirms server compatibility with your specific internet connection.',
      '',
      'Minimum bandwidth required:',
      '- SD: 5 Mbps',
      '- HD: 10-15 Mbps',
      '- 4K Ultra HD: 25+ Mbps',
      'For best stability on Smart TV or set-top box: use Ethernet cable instead of Wi-Fi.',
    ],
    troubleshooting: [
      { error: 'bloque|bloqué|blocage|freeze|buffer|ralentit|coupe|coupure', solution: 'Les opérateurs français (Orange, SFR, Bouygues, Free) bloquent parfois l\'IPTV, surtout pendant les matchs de foot. Utilisez un VPN configuré sur un pays européen voisin pour contourner le blocage instantanément.' },
      { error: 'code activation|activation code|code invalide|invalid code', solution: 'Vérifiez que vous avez saisi le code d\'activation exactement comme fourni. Les codes sont sensibles à la casse. Si le problème persiste, contactez le support pour vérifier que votre abonnement est actif.' },
      { error: 'connexion|login|login failed|échec|unauthorized|401', solution: 'Pour l\'application officielle Atlas Pro ONTV : vérifiez votre code d\'activation. Pour les applis tierces (TiviMate, Smarters) : vérifiez que l\'URL du serveur, le nom d\'utilisateur et le mot de passe Xtream Codes sont corrects. Essayez de copier-coller depuis l\'email.' },
      { error: 'epg|guide|programme|aucun programme', solution: 'Avec l\'application officielle Atlas Pro ONTV, l\'EPG se charge automatiquement. Avec les applis tierces en Xtream Codes, l\'EPG est généralement inclus. Assurez-vous que l\'EPG est activé dans les paramètres de votre lecteur.' },
    ],
  },
  {
    id: 'atlas_downloads_apps',
    keywords: ['download', 'téléchargement', 'app', 'application', 'apk', 'install', 'installer', 'atlas app', 'atlas pro app', 'atlas ontv apk', 'atlas ontv download', 'tivimate download', 'smarters download', 'gse download', 'vlc download'],
    audience: 'both',
    summary: "Atlas Pro IPTV has official apps for Android (Atlas Pro ONTV) and iOS (Atlas Pro IPTV Ontv GSE). Third-party apps like TiviMate, IPTV Smarters, GSE Smart IPTV, and VLC also work with Xtream Codes credentials. Download links: Atlas Pro ONTV APK → https://atlaspro.tv/atlas-pro-ontv.apk (Android TV/Fire TV). Atlas Pro IPTV Ontv GSE → Apple App Store (iPhone/iPad/Apple TV). TiviMate → Google Play or Amazon App Store. IPTV Smarters Pro → Google Play, App Store, or Amazon. GSE Smart IPTV → Apple App Store. VLC → videolan.org. Visit /downloads for all links organized by device.",
    steps: [
      '--- ATLAS OFFICIAL APPS ---',
      'Atlas Pro ONTV (Android TV / Fire TV):',
      'APK direct: https://atlaspro.tv/atlas-pro-ontv.apk',
      'Amazon App Store: search "Atlas Pro ONTV"',
      'Setup: install → open → enter activation code → watch.',
      '',
      'Atlas Pro IPTV Ontv GSE (iPhone / iPad / Apple TV):',
      'App Store: https://apps.apple.com/app/atlas-pro-iptv-ontv-gse/id6740336953',
      'Setup: install → open → enter subscriber code → watch.',
      '',
      '--- THIRD-PARTY APPS ---',
      'TiviMate (Firestick / Android TV):',
      'Google Play or Amazon App Store. Best premium IPTV player.',
      '',
      'IPTV Smarters Pro (All devices):',
      'Google Play or App Store. Universal, simple, reliable.',
      '',
      'GSE Smart IPTV (iOS / Apple TV):',
      'Apple App Store. Best for Apple devices.',
      '',
      'VLC Media Player (PC / Mac):',
      'videolan.org. Best for testing M3U links quickly.',
      '',
      'All download links are available at: https://dalletek.live/downloads',
    ],
    troubleshooting: [],
  },
  {
    id: 'atlas_activation_guide',
    keywords: ['activation', 'code activation', 'activer', 'how to activate', 'activation code', 'code', 'activation guide', 'guide activation', 'code atlas', 'subscriber code', 'code abonné'],
    audience: 'new',
    summary: "Atlas Pro IPTV uses activation codes for official apps and Xtream Codes credentials (username, password, server URL) for third-party apps. After purchase, you receive an email with both.",
    steps: [
      '--- ACTIVATION VIA OFFICIAL APPS ---',
      '1. Install Atlas Pro ONTV (Android/Fire TV) or Atlas Pro IPTV Ontv GSE (iOS).',
      '2. Open the app. You will see an "Activation Code" field.',
      '3. Enter the code you received by email after purchase.',
      '4. Click "Login" or "Connexion".',
      '5. Channels and EPG load automatically (10-30 seconds).',
      '',
      '--- ACTIVATION VIA THIRD-PARTY APPS ---',
      ...
      '5. Channels load. You can now watch on any device.',
      '',
      '--- WHAT TO DO IF YOUR CODE DOES NOT WORK ---',
      '- Double-check: codes are case-sensitive. Copy-paste from your email.',
      '- Server URL should NOT include /c/ or extra paths for Xtream login.',
      '- If using Atlas Pro ONTV: make sure you downloaded the official app.',
      '- Contact support if your code is still not working (include your order number).',
    ],
    troubleshooting: [],
  },
]
